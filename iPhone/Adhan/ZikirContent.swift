...
enum ZikirLibrary {
    static let all: [ZikirPhrase] = [
        ...
        .init(id: "friday-salawat-short", helperTitles: ["Friday remembrance", "A light selawat for today", "Send blessings with love"], helperTitlesMS: ["Zikir hari Jumaat", "Selawat ringan untuk hari ini", "Berselawat dengan kasih"], textArabic: "اللَّهُمَّ صَلِّ عَلَى مُحَمَّدٍ", translation: "O Allah, send blessings upon Muhammad.", translationMS: "Ya Allah, limpahkanlah selawat ke atas Muhammad.", category: .friday, weight: 5, isFridayBoost: true, maxRecommendedLength: 24),
        .init(id: "friday-salawat-complete", helperTitles: ["Friday remembrance", "A blessed way to fill the tongue", "Send blessings today"], helperTitlesMS: ["Zikir hari Jumaat", "Cara yang diberkati untuk membasahi lidah", "Berselawat hari ini"], textArabic: "اللَّهُمَّ صَلِّ وَسَلِّمْ عَلَى نَبِيِّنَا مُحَمَّدٍ", translation: "O Allah, bless and grant peace to our Prophet Muhammad.", translationMS: "Ya Allah, limpahkanlah selawat dan salam ke atas Nabi kami Muhammad.", category: .friday, weight: 4, isFridayBoost: true, maxRecommendedLength: 24),
        .init(id: "friday-sallallahu", helperTitles: ["Friday remembrance", "A short selawat for this moment", "Send blessings today"], helperTitlesMS: ["Zikir hari Jumaat", "Selawat ringkas untuk saat ini", "Berselawat hari ini"], textArabic: "صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ", translation: "Peace and blessings be upon him.", translationMS: "Selawat dan salam ke atas Baginda.", category: .friday, weight: 3, isFridayBoost: true, maxRecommendedLength: 22),
    ]
